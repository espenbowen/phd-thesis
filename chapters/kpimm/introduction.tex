...
The decay \BdToKpimm is a flavour-changing neutral-current process that proceeds via a \btosmm transition. In the SM, the leading order transition amplitudes are described by electroweak penguin or box diagrams.  In extensions to the SM, new heavy particles can contribute to loop diagrams and modify observables such as branching fractions and angular distributions.
