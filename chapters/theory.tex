...
\begin{table}[!tb]
\caption{Properties of the boson in the SM. The particle masses are taken from~\cite{pdg}.}
\begin{center}
...
The SM is formulated using the framework of Quantum Field Theory (QFT) where the fermions and bosons are represented by quantum fields. The dynamics of the SM particles are described by the SM Lagrangian,
...
%Quarks carry all three conserved quantum numbers and therefore participate in each of the fundamental interactions. Leptons do not carry color charge and, therefore, do not participate in the strong interaction. 

%In the SM, this corresponds to the electromagnetic, the strong and the weak forces. The properties of each of these bosons are shown in Table~\ref{tab:bosons}. Gravity, the weakest of the four fundamental forces, is not included in the SM.
